...
#define BANNERGIFTOCF (__bridge CFTypeRef)
#define BANNERGIFFROMCF (__bridge id)
#else
#define BANNERGIFTOCF (CFTypeRef)
#define BANNERGIFFROMCF (id)
#endif

@implementation UIImage (KJBannerGIF)
+ (UIImage*)kj_bannerGIFImageWithData:(NSData*)data{
    return animatedImageWithAnimatedGIFReleasingImageSource(CGImageSourceCreateWithData(BANNERGIFTOCF data, NULL));
}
